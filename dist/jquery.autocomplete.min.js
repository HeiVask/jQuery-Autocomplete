...
appendTo:"body",serviceUrl:null,lookup:null,onSelect:null,width:"auto",minChars:1,maxHeight:300,deferRequestBy:0,params:{},formatResult:function(a,b){if(!b)return a.value;var d=new RegExp(p.escapeRegExChars(b),"gi"),c=a.value.match(d);return null!==c?a.value.replace(d,"<strong>"+c.toString()+"</strong>"):a.value},formatGroup:function(a,b){return'<div class="autocomplete-group">'+b+"</div>"},delimiter:null,zIndex:9999,type:"GET",noCache:!1,onSearchStart:l,onSearchComplete:l,onSearchError:l,preserveInput:!1,
